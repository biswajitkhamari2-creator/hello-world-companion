...
import { A as isAbortError, At as APICallError, B as parseJsonEventStream, Ct as object$1, D as generateId, Dt as union, E as filterNullable, Et as string, F as isNonNullable, Ft as UnsupportedFunctionalityError, G as resolve, I as isProviderReference, It as getErrorMessage, J as safeParseJSON, L as isUrlSupported, Lt as isJSONArray, Mt as JSONParseError, N as isExecutableTool, O as getRuntimeEnvironmentUserAgent, Ot as unknown, P as isFullMediaType, Pt as TypeValidationError, Q as withUserAgentSuffix, R as lazySchema, Rt as isJSONObject, S as detectMediaType, St as number, T as fetchWithValidatedRedirects, Tt as strictObject, W as readResponseWithSizeLimit, Y as safeValidateTypes, Z as validateTypes, _ as convertUint8ArrayToBase64, _t as discriminatedUnion, c as DownloadError, d as asSchema, dt as _instanceof, et as zodSchema, f as cancelResponseBody, ft as _null, gt as custom, ht as boolean, j as isBuffer, jt as InvalidPromptError, kt as AISDKError, m as convertBase64ToUint8Array, mt as array$1, n as GatewayError, o as DEFAULT_MAX_DOWNLOAD_SIZE, q as retryWithExponentialBackoff, r as gateway, s as DelayedPromise, t as GatewayAuthenticationError, u as asArray, ut as _enum, vt as lazy, w as executeTool, wt as record, xt as never, y as createIdGenerator, yt as literal, z as normalizeHeaders } from "./gateway+[...].mjs";
				...
				async function processBlock() {
					...
					if (toolParts.length > 0) {
						...
						for (const toolPart of toolParts) {
							...
							if (toolPart.state === "approval-responded" && ((_f = toolPart.approval) == null ? void 0 : _f.approved) === false) content2.push({
								type: "tool-result",
...
//#endregion
export { streamText as a, dist_exports as i, DefaultChatTransport as n, require_jsx_runtime as o, convertToModelMessages as r, require_react as s, useChat as t };
