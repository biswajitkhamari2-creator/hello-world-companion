...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-Cl4xdT_s.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-3YeLvESP.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BUlZUI3L.mjs"),
		import("./start-DdmgS7KJ.mjs"),
