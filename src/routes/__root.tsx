...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sushama UPSC — AI Notes, MCQs & Current Affairs" },
      ...
      { property: "og:site_name", content: "Sushama UPSC" },
      { property: "og:locale", content: "en_IN" },
      { property: "og:title", content: "Sushama UPSC — AI Notes, MCQs & Current Affairs" },
      ...
      { name: "twitter:title", content: "Sushama UPSC — AI Notes, MCQs & Current Affairs" },
